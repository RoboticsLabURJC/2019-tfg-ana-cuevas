...
\begin{enumerate}
  ...
  \item Manejo de vídeos en MATLAB. Detección y estimación de movimiento:\\
  ...
  \item Mejora y restauración de vídeo. Filtrado interframe:\\
...
Lo siguiente es eliminar los marcadores que no coincidan con un núcleo en la imagen original, en Matlab se usa la función\textbf{ regionprops} con el atributo \emph{mean intensity}, \texbf{regionprops} en scipy-image tiene el mismo atributo con el mismo funcionamiento.\\
