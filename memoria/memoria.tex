...
\caption{Resultado de realizar la segmentación K-medias sobre componentes de ctextura carcterizados por la desviación típica y la entropía.}
...
\begin{figure}[!tbp]
  ...
  \caption{Diferencias entre las componentes a y b en la diferentes normas.}
  \label{normaslab}
\end{figure}
...
A continuación se crea una imagen que combina los marcadores internos y externos [\ref{marcadores}]. \\
